...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(message) => "Unknown error: ${message}";

  static String m1(statusCode) => "Server error: ${statusCode}";

  static String m2(message) => "Invalid argument: ${message}";

  static String m3(message) => "Logic error: ${message}";

  static String m4(message) => "Invalid data: ${message}";

  static String m5(message) => "Data access error: ${message}";

  static String m6(message) => "State error: ${message}";

  static String m7(message) => "Unsupported feature: ${message}";
